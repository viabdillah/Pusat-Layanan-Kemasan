// client/src/components/specific/CreateKemasanModal.jsx
import React, { useState } from "react";
import { HiX, HiOutlineArchive } from "react-icons/hi";
import { createKemasan } from "../../api/kemasan.api.js";
import toast from "react-hot-toast";

const CreateKemasanModal = ({ isOpen, onClose, onKemasanAdded, pelangganId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 2. Kirim semua data baru ke API
      await createKemasan({
        nama_kemasan: nama,
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
          <div>
            ...
            <input
              ...
              placeholder="Contoh: Keripik paria rasa Ori" // Placeholder baru
              required
          ...
          <div className="flex justify-end pt-4 space-x-3 border-t">
            ...
            >
              ...
              {loading ? "Menyimpan..." : "Simpan Kemasan"}
            </button>
          </div>
        </form>
      </div>
...
export default CreateKemasanModal;